...
/**
 * PrimitiveArray interface is used to represent a class wrapper for any primitive
 * array type.
 * 
...
public interface PrimitiveArray {
	...
	/**
	 * Return true if this PrimitiveArray contains all of the elements in the
	...
	/**
	 * Returns the last index of the specified Object, or -1 if the Object is not 
	 * in this PrimitiveArray.
	 * @param o The Object to find.
	 ...
	 * @throws ArrayIndexOutOfBoundsException Thrown if index is out-of-bounds.
	 * @throws IllegalArgumentException Thrown if o is not an instance of this
	 ...
	 * @throws IllegalArgumentException Thrown if start or end indices are 
	 * out-of-bounds or if start is greater than or equal to end..
	 * @since 21
	 */
	public PrimitiveArray subArray(int start, int end)throws IllegalArgumentException;
	
	/**
	 * Returns an array of the specified type, containing the elements in this
	 * PrimitiveArray. If all the elements can fit into the specified array,
	 * then that array is filled with this PrimitiveArray and returned. Otherwise,
	 * a new array is created of the specified type and filled with this
	 * PrimitiveArray and returned.
