...
/**
 * ArrayIterator class creates an Iterator for an Array. The ArrayIterator copies
 * the specified Array so that the Iterator is detached from the actual Array.
 * Therefore, changing the Array contents through the ArrayIterator will not
 * change the original Array. This allows the ArrayIterator to maintain the thread
